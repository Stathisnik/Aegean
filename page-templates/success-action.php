<?php /* Template Name: Success-action */ ?>
...
<div class="container">
  ...
  <p class="p-text"><?php echo pll__("Συγχαρητήρια για την υποβολή της δράσης σου!");?></p>
  
    <p class="p-text"> <?php echo pll__("Όταν αξιολογηθεί η δράση σου, θα λάβεις ειδοποίηση για την εξέλιξή της.");?></p>
