<?php /* Template Name: Submit Action */ ?>
    ...
    <main id="main" class="site-main" role="main">
        ...
        <div class="container forms">
            ...
            <img class="title-img-above" src="<?php echo get_stylesheet_directory_uri(); ?>/img/action-icon.svg" alt="">
                <h2 class="title-internal"><?php echo pll__("Υποβολή Δράσης");?></h2>
            
            
                <p class="submit-title"><?php echo pll__("Εδώ, μπορείτε να υποβάλλετε τη Δράση σας. Κάθε Δράση μπορεί να είναι αυτόνομη ή να υπόκειται στα πλαίσια ενός διαγωνισμού. Η δράση σας θα εμφανιστεί δημόσια μετά από την έγκριση των διαχειριστών. Για τις Δράσεις που έχουν υποβληθεί στα πλαίσια κάποιου Διαγωνισμού των Aegean Startups και μετά το πέρας αυτού, οι νικητήριες Δράσεις ενδέχεται να προχωρήσουν σε Crowdfunding.");?>
                </p>
        ...
        while ( have_posts() ) : the_post();
                ...
                if($lang == 'el'){
                 $settings = array(
                    ...
                    'field_groups' => array("group_5f0579cc5b005"),
                    ...
                    'submit_value' => pll__("Υποβολή Δράσης >", 'acf'),
                    ...
                    $settings = array(
                        ...
                        A special placeholder '%post_url%' will be converted to post's permalink (handy if creating a new post)
                        A special placeholder '%post_id%' will be converted to post's ID (handy if creating a new post) */
                        'return' => "https://aegean-startups.gr/en/success-action/",
...
<?php }else{
		 $url = get_home_url().'/cant-submit-an-action/';	
        wp_redirect($url);
        }?>
