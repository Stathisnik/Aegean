<?php /* Template Name: Submit Org need */ ?>
...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        <div class="container forms">
           <h2 class=" title-internal"><?php echo pll__("Υποβολή Aνάγκης Οργανισμου");?> </h2>
            <p class="submit-title"><?php echo pll__("Στο σημείο αυτό, καλούνται οι οργανισμοί που ήδη λειτουργούν, 
            να δηλώσουν τις ανάγκες τις οποίες πιστεύουν ότι θα μπορούσαν να καλύψουν νεοφυείς επιχειρήσεις.");?>
</p>
        ...
        while ( have_posts() ) : the_post();
                $title_cf =  get_the_ID();
                 ...
                 $settings = array(
                    ...
                    'field_groups' => array("group_5f9817f8cc612"),
        ...
        <?php }else{
		 $url = get_home_url().'/cant-submit-a-need/';	
        wp_redirect($url);
        }?>
